...
<html lang="en">
  <head>
    ...
    <title>OneTech Admin Template</title>
    ...
    <!-- Starlight CSS -->
    <link rel="stylesheet" href="{{ asset('public/dashboard/css/starlight.css') }}">
  </head>
  ...
  <body>
    ...
    @else
        ...
        <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> OneTech</a></div>
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="{{ asset('public/dashboard/img/img3.jpg') }}" class="wd-32 rounded-circle" alt="">
            </a>
    ...
    <script src="{{ asset('public/dashboard/lib/jquery/jquery.js') }}"></script>
    <script src="{{ asset('public/dashboard/lib/popper.js/popper.js') }}"></script>
    <script src="{{ asset('public/dashboard/lib/bootstrap/bootstrap.js') }}"></script>
    <script src="{{ asset('public/dashboard/lib/jquery-ui/jquery-ui.js') }}"></script>
    <script src="{{ asset('public/dashboard/lib/perfect-scrollbar/js/perfect-scrollbar.jquery.js') }}"></script>
    <script src="{{ asset('public/dashboard/lib/jquery.sparkline.bower/jquery.sparkline.min.js') }}"></script>
    <script src="{{ asset('public/dashboard/lib/d3/d3.js') }}"></script>
    <script src="{{ asset('public/dashboard/lib/rickshaw/rickshaw.min.js') }}"></script>
    <script src="{{ asset('public/dashboard/lib/chart.js/Chart.js') }}"></script>
    <script src="{{ asset('public/dashboard/lib/Flot/jquery.flot.js') }}"></script>
