            ...
            <div class="content_wrapper">
                ...
                <div class="registration_page center_container">
                    <div class="center_content">
                        <div class="logo">
                            <img src="{{asset('public/panel/assets/images/register.png')}}" alt="" class="img-fluid">
                        </div>
                        ...
                        <div class="footer">
                            <p>Copyright &copy; 2023 <a href="https://easylearningbd.com/">OneTech</a>. All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div><!--/ content wrapper -->
