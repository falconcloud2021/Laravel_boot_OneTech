  ...
  <div class="sidebar-inner px-4 pt-3">
    <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
      <div class="d-flex align-items-center">
        <div class="avatar-lg me-4">
          <img src="public/dashboard/assets/img/team/profile-picture-3.jpg" class="card-img-top rounded-circle border-white"
            alt="Bonnie Green">
        </div>
        <div class="d-block">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      <li class="nav-item">
        <a href="#" class="nav-link d-flex align-items-center">
          <span class="sidebar-icon">
            <img src="public/dashboard/assets/img/brand/light.svg" height="20" width="20" alt="Volt Logo">
          </span>
      ...
      <li class="nav-item">
        ...
        <div class="multi-level collapse " role="list"
          id="submenu-orders" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item">
              <a class="nav-link" target="_blank"
                href="#">
                <span class="sidebar-text">Orders list</span>
              </a>
            </li>
            <li class="nav-item ">
              <a class="nav-link" href="#">
      ...
      <li class="nav-item">
        ...
        <div class="multi-level collapse " role="list"
          id="submenu-products" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item">
              <a class="nav-link" target="_blank"
                href="#">
            ...
            <li class="nav-item ">
              <a class="nav-link" href="#">
                <span class="sidebar-text">Track</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <li class="nav-item">
        <span class="nav-link  collapsed  d-flex justify-content-between align-items-center"
          data-bs-toggle="collapse" data-bs-target="#submenu-app"><span>
            <span class="sidebar-icon">
            ...
            <span class="sidebar-text">Categories section</span>
          </span>
          <span class="link-arrow">
            <svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
          </span>
          ...
          <ul class="flex-column nav">
            <li class="nav-item ">
              <a class="nav-link" href="{{ route('tags.index') }}">
                <span class="sidebar-text">Tags list</span>
              </a>
            </li>
          </ul>
          <ul class="flex-column nav">
            <li class="nav-item ">
              <a class="nav-link" href="{{ route('colors.index') }}">
                <span class="sidebar-text">Colors list</span>
              </a>
            </li>
          </ul>
          <ul class="flex-column nav">
            <li class="nav-item ">
              <a class="nav-link" href="{{ route('categories.index') }}">
                <span class="sidebar-text">Categories list</span>
              </a>
            </li>
          </ul>
          <ul class="flex-column nav">
            <li class="nav-item ">
              <a class="nav-link" href="{{ route('subcategories.index') }}">
                <span class="sidebar-text">Subcategories list</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <li class="nav-item">
        <span class="nav-link  collapsed  d-flex justify-content-between align-items-center"
          data-bs-toggle="collapse" data-bs-target="#submenu-crm"><span>
            <span class="sidebar-icon">
              <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 4a3 3 0 00-3 3v6a3 3 0 003 3h10a3 3 0 003-3V7a3 3 0 00-3-3H5zm-1 9v-1h5v2H5a1 1 0 01-1-1zm7 1h4a1 1 0 001-1v-1h-5v2zm0-4h5V8h-5v2zM9 8H4v2h5V8z" clip-rule="evenodd"></path></svg>
            </span> 
        ...
        <div class="multi-level collapse "
          role="list" id="submenu-crm" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item ">
              <a class="nav-link" href="{{ route('tags.index') }}">
      ...
      <li class="nav-item">
        <span class="nav-link  collapsed  d-flex justify-content-between align-items-center"
          data-bs-toggle="collapse" data-bs-target="#submenu-erp"><span>
            <span class="sidebar-icon">
              <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 4a3 3 0 00-3 3v6a3 3 0 003 3h10a3 3 0 003-3V7a3 3 0 00-3-3H5zm-1 9v-1h5v2H5a1 1 0 01-1-1zm7 1h4a1 1 0 001-1v-1h-5v2zm0-4h5V8h-5v2zM9 8H4v2h5V8z" clip-rule="evenodd"></path></svg>
            </span> 
            <span class="sidebar-text">ERP</span>
          </span>
          <span class="link-arrow">
            <svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
          </span>
        ...
        <div class="multi-level collapse "
          role="list" id="submenu-erp" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item ">
              <a class="nav-link" href="{{ route('tags.index') }}">
                <span class="sidebar-text">Kanban</span>
      ...
      <li class="nav-item">
        <a href="#" target="_blank" class="nav-link d-flex justify-content-between">
          ...
          <span>
            <span class="badge badge-sm bg-secondary ms-1 text-gray-800">New</span>
          </span>
        </a>
      </li>
      <li class="nav-item ">
      ...
      <li class="nav-item">
        <a href="#" target="_blank" class="nav-link d-flex align-items-center">
          <span class="sidebar-icon">
            <img src="public/dashboard/assets/img/themesberg.svg" height="20" width="28" alt="Themesberg Logo">
          </span>
