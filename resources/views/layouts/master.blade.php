...
<link rel="stylesheet" type="text/css" href="{{ asset('public/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css') }}">
...
<link rel="stylesheet" type="text/css" href="{{ asset('public/plugins/slick-1.8.0/slick.css') }}">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">OneTech</a>
...
<script src="{{ asset('public/plugins/slick-1.8.0/slick.js') }}"></script>
